...
{
	*this = src;
	std::cout << "A copy of " << this->getName() << " has appeared!" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << this->getName() << " has appeared!" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	this->_energyPoints -= 1;
	this->_hitPoints += amount;
	std::cout << "ClapTrap " << this->_name << " HP have been regenerated with a total of " << amount << " points !" << std::endl;
}

void	ClapTrap::setName(std::string name)
{
	this->_name = name;
	std::cout << "ClapTrap name is now " << this->_name << std::endl;
}

void	ClapTrap::setAttackDamage(unsigned int amount)
{
	this->_attackDamage = amount;
	std::cout << "ClapTrap " << this->_name << " AD is now " << this->_attackDamage << std::endl;
}

void	ClapTrap::setEnergyPoints(unsigned int amount)
{
	this->_energyPoints = amount;
	std::cout << "ClapTrap " << this->_name << " EP is now " << this->_energyPoints << std::endl;
}

void	ClapTrap::setHitPoints(unsigned int amount)
{
	this->_hitPoints = amount;
	std::cout << "ClapTrap " << this->_name << " HP is now " << this->_hitPoints << std::endl;
}
